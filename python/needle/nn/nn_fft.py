...
class FFTConv2d(Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        in_padded = ndarray.full((N, C, conv_H, conv_W), 0+0j, dtype=complex, device=x.device)
        ...
        K_pad = ndarray.full((self.in_channels, self.out_channels, conv_H, conv_W), 0+0j,
                                dtype="complex64", device=K.device)
        ...
        K_pad[..., :kh, :kw] = K_flipped.astype("complex64")
